...
function useEventListener(eventName, handler, element = document) {
  ...
  const PointerTest = () => {
    return (
      <div className="pointertest">
        <AnimatedCursor/>
        <section>
          <h1>Testing Pointer in Isolation</h1>
          <hr/>
          <h3>AnimatedCursor function seems to load before the rest of the page, causing a JavaScript TypeError: Cannot read property 'style' of null error. </h3>
        </section>
      </div>
    );
  }
